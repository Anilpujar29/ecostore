...
public class HttpClient implements CommandLineRunner {
    ...
    private void sendValue(String url, EnvironmentProperties.Device device) throws URISyntaxException, IOException, InterruptedException {
    ...
    private HttpRequest.BodyPublisher getRequestBody(EnvironmentProperties.Device device) {
        return HttpRequest.BodyPublishers.ofString("{\"" + device.getTelemetry() + "\": " + getValue(device.getRange()) + "}");
    }
